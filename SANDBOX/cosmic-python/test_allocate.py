...
def test_prefers_current_stock_batches_to_shipments():
    in_stock_batch = Batch("in-sotck-batch", "RETRO-CLOCK", 100, eta=None)
...
def test_prefers_earlier_batches():
    ...
    latest = Batch(
        "slow-batch", "MINIMALIST-SPOON", 100, eta=date.today() + timedelta(days=5)
    )
...
def test_returns_allocated_branch_ref():
